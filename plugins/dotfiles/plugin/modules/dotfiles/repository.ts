...
export interface ManagedDotfilesRepository extends DotfilesRepository {
  dispose(): void;
}
...
export function createDotfilesRepository({
  files,
  getConfiguredRepoPath,
}: RepositoryDependencies): ManagedDotfilesRepository {
