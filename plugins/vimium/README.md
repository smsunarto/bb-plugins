...
- A hint that opens a dropdown re-prompts automatically, with hints scoped to the dropdown's options and labels starting on the strongest home-row keys (`f`, `j`, `d`, `k`, ...).
