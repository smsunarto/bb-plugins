...
Use worktree-relative paths. Do not put directives in inline code or fenced code blocks. Add at most three embeds. Spend them on the claims a reader would actually want to check, not on every file you touched.
