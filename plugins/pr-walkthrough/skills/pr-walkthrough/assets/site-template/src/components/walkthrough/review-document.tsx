...
export function ReviewDocument({
  ...
  const primaryFiles = useMemo(() => groupFiles.filter((file) => !file.generated), [groupFiles])
  const generatedFiles = useMemo(() => groupFiles.filter((file) => file.generated), [groupFiles])
  const treeFiles = useMemo(
    () => showGeneratedFiles || primaryFiles.length === 0 ? groupFiles : primaryFiles,
        ...
        <div className="w-full min-w-0 max-w-none px-4 pb-5 pt-4 lg:px-6">
          <header>
            <div className="flex items-start justify-between gap-4">
              ...
              <Toggle
                aria-label={viewed ? "Mark group as not reviewed" : "Mark reviewed"}
                ...
                variant="outline"
              >
                {viewed ? <Check className="text-[var(--added)]" /> : null}{viewed ? "Reviewed" : "Mark reviewed"}
              </Toggle>
            </div>
            ...
            <>
              <div className="mb-2 mt-4 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  {generatedFiles.length > 0 && primaryFiles.length > 0 ? (
                    <Toggle
                      aria-label={showGeneratedFiles ? "Hide generated files" : "Show generated files"}
                      ...
                      variant="outline"
                    >
                      <FileCog />{showGeneratedFiles ? "Hide generated" : "Show generated"}
                    </Toggle>
                  ) : null}
                  <ToggleGroup
