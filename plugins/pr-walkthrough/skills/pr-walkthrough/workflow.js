...
1. bun run ${skillDir}/scripts/scaffold-site.ts --content .pr-walkthrough/walkthrough --diff .pr-walkthrough/changes.patch --output .pr-walkthrough/site
2. bun install --cwd .pr-walkthrough/site
3. bun run --cwd .pr-walkthrough/site check
4. bun run ${skillDir}/scripts/validate-site-template.ts --site .pr-walkthrough/site --built
...
- Serve with: bun run ${skillDir}/scripts/serve-static.ts --directory .pr-walkthrough/site/out --bind 127.0.0.1 --port 4173
