import type { CLICommand, CLIContext, CLIResult } from "./program.ts";
import { commandDefinitions, runProgram } from "./program.ts";
import type { UnionToIntersection } from "./procedure.ts";

/** Public surface of `@bb-kit/core/cli` (§1, §4). */
export { CLIError } from "./program.ts";
export type { CLIResult, CLIContext } from "./program.ts";
